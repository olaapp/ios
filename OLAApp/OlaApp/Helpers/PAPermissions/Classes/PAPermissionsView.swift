...
class PAPermissionsView: UIView, UITableViewDataSource, UITableViewDelegate {
	...
	fileprivate func setupTitleLabel() {
        ...
        self.titleLabel.font = UIFont(name: K.font.fontRegular, size: 30)
	...
	fileprivate func setupDetailsLabel() {
		if self.detailsLabel == nil {
			...
			self.detailsLabel.text = "Detalles"
            // handle multi line details text
            self.detailsLabel.numberOfLines = 0
            self.detailsLabel.lineBreakMode = .byWordWrapping
		}
		
		self.detailsLabel.font = UIFont(name: K.font.fontRegular , size: 15)
	...
	fileprivate func setupContinueButton() {
		...
		self.continueButton.titleLabel?.font = UIFont(name: K.font.fontBold, size: 15)
		self.continueButton.titleLabel?.minimumScaleFactor = 0.1
		self.continueButton.setTitle(NSLocalizedString("Continuar", comment: ""), for: UIControl.State())
